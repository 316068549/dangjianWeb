        ...
        <div class="container">
            <div class="box">
                ...
                <div class="content_box">
                    ...
                    <div class="newtime">
                        <span>{{news.type}}</span>   |   <span>{{news.org}}</span>   |   <span>{{news.createTime}}</span>
                        <!--|   <span>阅读：2587</span>-->
                    </div>

                    <div class="newcon">
                        <p class="text-left">{{news.content}}</p>
                        <div>
                            <div class="block">


                                    <!--<h2 style="font-size: 14px;">请在每个发展对象中选择出三名你认为可以成为预备党员的人选</h2>-->
                                    <el-form ref="form" :model="form" label-width="30px">
                                        <!--<el-form-item label="请在每个">-->
                                            <!--<el-input v-model="form.name"></el-input>-->
                                        <!--</el-form-item>-->
                                        <el-form-item label="">
                                            <el-checkbox-group v-model="form.names">
                                                <el-checkbox label="测试1" name="names"></el-checkbox>
                                                <el-checkbox label="测试2" name="names"></el-checkbox>
                                                <el-checkbox label="测试3" name="names"></el-checkbox>
                                                <el-checkbox label="test1" name="names"></el-checkbox>
                                                <el-checkbox label="test2" name="names"></el-checkbox>
                                                <el-checkbox label="test3" name="names"></el-checkbox>
                                            </el-checkbox-group>
                                        </el-form-item>
                                        <el-form-item>
                                ...
                                <!--<ul class="el-timeline is-reverse">-->
                                    <!--<li class="el-timeline-item">-->
                                        ...
                                        <!--<div class="el-timeline-item__node el-timeline-item__node&#45;&#45;normal el-timeline-item__node&#45;&#45;">&lt;!&ndash;&ndash;&gt;</div>-->
                                        <!--&lt;!&ndash;&ndash;&gt;<div class="el-timeline-item__wrapper">&lt;!&ndash;&ndash;&gt;<div class="el-timeline-item__content">-->
                                <!--</div>-->
        ...
        data() {
            return {
                ...
                news:{
                    ...
                    org: '第一党小组',
                    author: '张晓',
                    startTime: '2020-12-21 09:00',
                    endTime: '2020-12-21 11:00',
                    status: '已结束',
                    content: '本着公平公正公开的原则，就针对于确定预备党员的名单，我支部将开展一次全体党员投票环节，请在每个发展对象中选择出三名你认为可以成为预备党员的人选，投票截止时间为2020-12-31 11:00。',
