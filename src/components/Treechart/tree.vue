...
<style scoped lang="scss">
    ...
    .extend_handle{position: absolute;left:50%;bottom: 24px;
        width: 10px;
        height: 10px;
        padding: 10px;
        transform: translate3d(-12px, 0, 0);cursor: pointer;}
    ...
    .node .person{padding-top: 15px; position: relative; display: inline-block;z-index: 2;width:97px; overflow: hidden;}
    .node .person .avat{
        padding: 5px;
        padding-top: 10px;
